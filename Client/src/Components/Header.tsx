  ...
  return (
    <div className="flex bg-BG-Dark text-UI-6 text-5xl px-4 min-h-10 w-full">
      ...
      {isAuthenticated && user && <div className="grow justify-end items-center text-Text-Ligth flex gap-7 ">
        ...
        <button 
        className="flex gap-2 bg-Accent-Secondary p-2 rounded-full opacity-45 text-Text-Dark hover:opacity-100 hover:text-Text-Ligth cursor-pointer" onClick={logout}>
